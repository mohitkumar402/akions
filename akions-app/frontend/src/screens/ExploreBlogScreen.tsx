...
export const ExploreBlogScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  useEffect(() => {
    loadBlogs();
    const searchParam = navigation.getState()?.routes?.find((r: { name?: string }) => r.name === 'ExploreBlog')?.params?.searchQuery;
    if (searchParam) {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.headerContainer}>
          <View style={styles.headerContent}>
            <Text style={styles.title}>Explore Blogs</Text>
            <Text style={styles.subtitle}>Discover insights, updates, and stories from the Ekions community.</Text>
          </View>
        </View>
